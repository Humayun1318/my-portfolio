  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          {/* Optional Overlay if you still want */}
          {/* <Overlay /> */}

          <motion.div
            ref={modalRef}
            className={cn(
              "relative z-[60] flex h-[90vh] max-h-[90vh] w-[80vw] max-w-[80vw] flex-col overflow-hidden border border-transparent bg-white md:rounded-2xl dark:border-neutral-800 dark:bg-neutral-950",
              className
            )}
...
export const ModalContent = ({
  ...
  return (
    <div className={cn("flex flex-1 flex-col overflow-hidden p-8 md:p-10", className)}>
      {children}
    </div>
  );
};
